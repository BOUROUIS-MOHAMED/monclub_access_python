...
TV_LOCAL_ROUTE_SPECS: tuple[RouteSpec, ...] = (
    ...
    ("GET", "/api/v2/tv/dashboard/screens", "_handle_tv_dashboard_screens_list"),
    ("GET", "/api/v2/tv/dashboard/screens/{screenId}", "_handle_tv_dashboard_screen_detail"),
    ("GET", "/api/v2/tv/dashboard/screens/{screenId}/content-plan", "_handle_tv_dashboard_screen_content_plan"),
    ("GET", "/api/v2/tv/dashboard/screens/{screenId}/snapshots", "_handle_tv_dashboard_screen_snapshots"),
    ("GET", "/api/v2/tv/dashboard/screens/{screenId}/snapshots/latest", "_handle_tv_dashboard_screen_latest_snapshot"),
    ("GET", "/api/v2/tv/dashboard/snapshots/{snapshotId}", "_handle_tv_dashboard_snapshot_detail"),
    ("GET", "/api/v2/tv/dashboard/snapshots/{snapshotId}/asset-manifest", "_handle_tv_dashboard_snapshot_manifest"),
    ...
    ("GET", "/api/v2/tv/db/tables", "_handle_tv_db_tables"),
    ("GET", "/api/v2/tv/db/table/{tableName}", "_handle_tv_db_table_query"),
