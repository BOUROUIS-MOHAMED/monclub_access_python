...
ACCESS_LOCAL_ROUTE_SPECS: tuple[RouteSpec, ...] = (
    ...
    ("POST", "/api/v2/logs/flush", "_handle_logs_flush"),
    ...
    ("GET", "/api/v2/feedback/sounds/anti-fraud-duration", "_handle_feedback_sound_anti_fraud_duration_get"),
    ("POST", "/api/v2/feedback/sounds/anti-fraud-duration", "_handle_feedback_sound_anti_fraud_duration_post"),
    ("DELETE", "/api/v2/feedback/sounds/anti-fraud-duration", "_handle_feedback_sound_anti_fraud_duration_delete"),
    ("GET", "/api/v2/feedback/sounds/anti-fraud-daily-limit", "_handle_feedback_sound_anti_fraud_daily_limit_get"),
    ("POST", "/api/v2/feedback/sounds/anti-fraud-daily-limit", "_handle_feedback_sound_anti_fraud_daily_limit_post"),
    ("DELETE", "/api/v2/feedback/sounds/anti-fraud-daily-limit", "_handle_feedback_sound_anti_fraud_daily_limit_delete"),
