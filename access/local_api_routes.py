...
ACCESS_LOCAL_ROUTE_SPECS: tuple[RouteSpec, ...] = (
    ...
    ("GET", "/api/v2/members", "_handle_members_roster"),
    ("POST", "/api/v2/members/photo", "_handle_member_photo"),
    ...
    ("GET", "/api/v2/offline-subresources", "_handle_offline_subresources_list"),
    ("POST", "/api/v2/offline-subresources/process-due", "_handle_offline_subresources_process_due"),
    ("POST", "/api/v2/members/mutation", "_handle_member_mutation"),
    ("GET", "/api/v2/mutations", "_handle_mutations_list"),
    ("POST", "/api/v2/mutations/process-due", "_handle_mutations_process_due"),
    ("POST", "/api/v2/mutations/{localId}/retry", "_handle_mutation_retry"),
    ("POST", "/api/v2/mutations/{localId}/cancel", "_handle_mutation_cancel"),
    ("POST", "/api/v2/mutations/{localId}/resolve", "_handle_mutation_resolve"),
    ...
    ("GET", "/api/v2/devices/{deviceId}/settings", "_handle_device_settings_get"),
    ("POST", "/api/v2/devices/{deviceId}/reentry", "_handle_device_reentry_set"),
    ("GET", "/api/v2/devices/{deviceId}/clock", "_handle_device_clock_get"),
    ("POST", "/api/v2/devices/{deviceId}/clock/sync", "_handle_device_clock_sync"),
    ("GET", "/api/v2/devices/{deviceId}/mirror-plan", "_handle_device_mirror_plan_get"),
    ("POST", "/api/v2/devices/{deviceId}/mirror/arm", "_handle_device_mirror_arm"),
