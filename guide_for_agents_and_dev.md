...
applied for you. Add `--ignore-glob='**/pytest_tmp_*' --ignore-glob='**/.tmp_pytest*'`
when stale permission-denied temp folders exist under `tests/`. Last run:
**968 passed** (2026-09-04). `[TEST]`
